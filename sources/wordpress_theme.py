...
class WordPressThemeSource(BaseSource):
    """
    A reusable base scraper for anime/donghua sites running on the standard
    WordPress anime theme (like Anichin and AnimeXin).
    """
